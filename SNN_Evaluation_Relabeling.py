...
start_time_relabeling = 0
end_time_relabeling = int(training_ending)
...
print('load results generated by relabling phase')
testing_result_monitor = np.load(data_path + 'resultPopVecs' + relabeling_ending + 'STPrelabling.npy')
testing_input_numbers = np.load(data_path + 'inputNumbers' + relabeling_ending + 'STPrelabling.npy')

print('load new assignments generated by relabling phase')
assignments = get_new_assignments(testing_result_monitor[start_time_relabeling:end_time_relabeling], testing_input_numbers[start_time_relabeling :end_time_relabeling ])
np.save(data_path + 'assignment' + str(n_e), assignments)

#--#########################################################
#accuracy calculation
#----------------------------------------------
counter = 0 
num_tests = end_time_relabeling //training_ending
