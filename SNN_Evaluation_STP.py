...
testing_result_monitor = np.load(data_path + 'resultPopVecs' + testing_ending + 'STP.npy')
testing_input_numbers = np.load(data_path + 'inputNumbers' + testing_ending + 'STP.npy')
print('get assignments')
#lables assigned to exc neurons after the process of training in Pipeline 1
#or aftre the process of relabling following by adding STP in pipeline 2
